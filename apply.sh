...
original_author="isaiah2004"
original_name="base"
original_urlname="base"
original_description="Awesome base created by isaiah2004" 
...
then
    ...
    echo "then run 'base' or 'python -m base'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'base' or 'python -m base' or 'poetry run base'"
fi
